...
def index(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            return render(request, 'index.html', {"question":question, "response":response, "past_responses":past_responses})
        
        except Exception as e:
            return render(request, 'index.html', {"question":question, "response":e, "past_responses":past_responses})
